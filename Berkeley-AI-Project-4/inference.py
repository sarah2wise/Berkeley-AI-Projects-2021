...
class DiscreteDistribution(dict):
    ...
    def sample(self):
        ...
        # if total != 0:
        #     for key in self:
        #         newdist[key] = self[key]/total + prev
        #         if newdist[key] >= p and prev <= p:
        #             return key
        #         prev = newdist[key]
        # return 0
...
class ExactInference(InferenceModule):
    ...
    def observeUpdate(self, observation, gameState):
        ...
        for pos in self.allPositions:
            ...
            tempBeliefs[pos] = obsProb * self.beliefs[pos]
    ...
    def elapseTime(self, gameState):
        ...
        for pos in self.beliefs:
            ...
            for newPos in posDist:
                tempBeliefs[newPos] += posDist[newPos] * self.beliefs[pos]
...
class ParticleFilter(InferenceModule):
    ...
    def observeUpdate(self, observation, gameState):
        ...
        beliefs = self.getBeliefDistribution().copy()
        for particle in self.getBeliefDistribution():
            obsProb = self.getObservationProb(observation, pacPos, particle, jailPos)
    ...
    def elapseTime(self, gameState):
        ...
        for pos in self.particles:
            ...
            tempParts.append(newPos)

        self.particles = tempParts
    ...
    def observeUpdate(self, observation, gameState):
        ...
        for particle in beliefs:
            for i in range(self.numGhosts):
                obsProb = self.getObservationProb(observation[i], pacPos, particle[i], self.getJailPosition(i))
                beliefs[particle] *= obsProb   
